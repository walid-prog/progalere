...
const I18N = {
  fr: {
    ...
    "about.story.eyebrow": "Notre histoire", "about.story.h1": "Notre histoire, en quatre chapitres.",
    "about.ch1.tag": "Chapitre 01", "about.ch1.h2": "Deux mondes qui ne se parlaient pas assez.",
    "about.ch1.p1": "L'un des cofondateurs venait du monde de l'audit&nbsp;: des années à éplucher les chiffres d'entreprises de toutes tailles, à voir de l'intérieur ce qui séparait une PME qui respire de celle qui s'essouffle. Ce n'était presque jamais une question de talent ou d'effort. C'était une question de <strong>temps perdu</strong>&nbsp;: des heures englouties dans la tenue de livres, des processus manuels qui auraient dû être automatisés depuis longtemps, des décisions prises à l'aveugle faute de chiffres à jour.",
    "about.ch1.toolsLabel": "Ses outils&nbsp;:",
    "about.ch2.tag": "Chapitre 02", "about.ch2.h2": "Un même problème, vu sous un autre angle.",
    "about.ch2.p1": "L'autre cofondatrice venait du marketing, à la tête d'une agence qui accompagnait des dizaines d'entreprises sur leur positionnement, leurs campagnes, leur image. Le même constat, vu sous un autre angle&nbsp;: des entreprises qui avaient d'excellents produits ou services, mais qui restaient invisibles, ou qui communiquaient sans direction claire, faute de stratégie cohérente.",
    "about.ch2.p2": "Deux expertises, un même problème observé sous deux angles différents. Les PME et les travailleurs autonomes jonglent avec trop de prestataires, trop peu connectés entre eux, pour un résultat qui reste <strong>fragmenté</strong>.",
    "about.ch2.toolsLabel": "Ses outils&nbsp;:",
    "about.ch3.tag": "Chapitre 03", "about.ch3.h2": "Une décision simple&nbsp;: arrêter de séparer ce qui devrait être ensemble.",
    "about.ch3.p1": "Plutôt que de continuer chacun de son côté, les deux cofondateurs ont choisi de réunir leurs expertises sous un même toit. Pas pour empiler des services de plus, mais pour offrir ce qu'ils cherchaient eux-mêmes en tant que professionnels&nbsp;: un seul point de contact, qui comprend à la fois les chiffres et la marque, capable de connecter la comptabilité, l'automatisation, la stratégie et la formation dans une seule vision cohérente.",
    "about.ch3.p2": "C'est ce qui donne son nom à <strong>Wavora</strong>, l'idée d'un mouvement continu, de vagues qui se rejoignent plutôt que de silos qui s'ignorent.",
    "about.ch3.p3": "Pour livrer cette vision avec la même exigence sur chaque expertise, les deux cofondateurs se sont entourés d'une équipe complète de spécialistes, capable de couvrir chaque aspect d'un mandat avec la même rigueur, du premier chiffre analysé jusqu'à la dernière campagne lancée.",
    "about.ch4.tag": "Chapitre 04", "about.ch4.h2": "Une vision qui dépasse le point de départ.",
    "about.ch4.p1": "Wavora a commencé avec quatre piliers&nbsp;: comptabilité opérationnelle, automatisation, stratégie et formations. Mais l'ambition ne s'arrête pas là. À mesure que les besoins des PME évoluent, avec l'<strong>IA</strong> qui redéfinit ce qui est possible pour une petite entreprise, Wavora entend élargir ce qu'elle offre, toujours dans la même logique&nbsp;: moins de fragmentation, plus de clarté, un seul partenaire de confiance pour grandir.",
  ...
  en: {
    ...
    "about.story.eyebrow": "Our story", "about.story.h1": "Our story, in four chapters.",
    "about.ch1.tag": "Chapter 01", "about.ch1.h2": "Two worlds that didn't talk to each other enough.",
    "about.ch1.p1": "One of the co-founders came from the world of auditing&nbsp;: years spent poring over the numbers of companies of every size, seeing firsthand what separated an SMB that thrives from one running out of breath. It was almost never a question of talent or effort. It was a question of <strong>wasted time</strong>&nbsp;: hours sunk into bookkeeping, manual processes that should have been automated long ago, decisions made blind for lack of up-to-date numbers.",
    "about.ch1.toolsLabel": "Their tools&nbsp;:",
    "about.ch2.tag": "Chapter 02", "about.ch2.h2": "The same problem, seen from another angle.",
    "about.ch2.p1": "The other co-founder came from marketing, leading an agency that supported dozens of businesses on their positioning, campaigns, and image. The same observation, seen from another angle&nbsp;: businesses with excellent products or services that stayed invisible, or communicated without a clear direction, for lack of a coherent strategy.",
    "about.ch2.p2": "Two areas of expertise, one same problem seen from two different angles. SMBs and self-employed workers juggle too many providers, too disconnected from each other, for a result that stays <strong>fragmented</strong>.",
    "about.ch2.toolsLabel": "Their tools&nbsp;:",
    "about.ch3.tag": "Chapter 03", "about.ch3.h2": "A simple decision&nbsp;: stop separating what should be together.",
    "about.ch3.p1": "Rather than keep going their separate ways, the two co-founders chose to bring their expertise together under one roof. Not to stack on more services, but to offer what they themselves were looking for as professionals&nbsp;: a single point of contact who understands both the numbers and the brand, able to connect accounting, automation, strategy, and training into one coherent vision.",
    "about.ch3.p2": "That's where the name Wavora comes from&nbsp;: the idea of a continuous movement, of waves coming together rather than silos ignoring each other.",
    "about.ch3.p3": "To deliver on that vision with the same standard across every area of expertise, the two co-founders brought together a full team of specialists, able to cover every aspect of an engagement with the same rigor, from the first number analyzed to the last campaign launched.",
    "about.ch4.tag": "Chapter 04", "about.ch4.h2": "A vision that goes beyond the starting point.",
    "about.ch4.p1": "Wavora started with four pillars&nbsp;: operational accounting, automation, strategy, and training. But the ambition doesn't stop there. As SMBs' needs evolve, with <strong>AI</strong> redefining what's possible for a small business, Wavora intends to expand what it offers, always with the same logic&nbsp;: less fragmentation, more clarity, a single trusted partner to help you grow.",
